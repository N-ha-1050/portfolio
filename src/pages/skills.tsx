...
const Skills: NextPage = () => (
    <SetInline>
        ...
        <ul className="m-4">
            <li>
                <span>C++, Rust</span> 競技プログラミングに使ったことがある、
                C++ は初期の頃に使用、 Rust は勉強中(なお、現在のメインは
                Python)
            </li>
            <li>
                <span>Go</span>{" "}
            ...
            <li>
                <span>Ruby, C</span> 高校のときに受けた高大連携の講義で使用
            </li>
            <li>
                <span>Visual Basic</span> vbs
                は中学の時に初めてプログラミングをした言語、その後 VBA や VB.NET
                も少し
            </li>
            <li>
                <span>Hot Soup Processor</span>{" "}
